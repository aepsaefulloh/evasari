                ...
                <div class="row">
                    <div class="col-md-6 col-xs-6 mt-5">
                        <div class="card" style="border: 0;">
                            <img src="<?php echo ROOT_URL?>/assets/img/service/1.png"
                                class="card-img-top rounded-img img-recent" alt="...">
                            <div class="card-body card-recent-article">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h4 class="card-text text-green text-bold mb-1">Unit Gawat Darurat (UGD)</h4>
                                    </div>
                    ...
                    <div class="col-md-6 col-xs-6 mt-5">
                        <div class="card" style="border: 0;">
                            <img src="<?php echo ROOT_URL?>/assets/img/service/2.png"
                                class="card-img-top rounded-img img-recent" alt="...">
                            <div class="card-body card-recent-article">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h4 class="card-text text-green text-bold mb-1">Imunisasi Anak</h4>
                                    </div>
                                    <div class="col-md-2 align-self-center">
                                        <a href="" class="arrow-read">
                                            <i class="fa fa-arrow-right"></i>
                    ...
                    <div class="col-md-6 col-xs-6 mt-5">
                        <div class="card" style="border: 0;">
                            ...
                            <div class="card-body card-recent-article">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h4 class="card-text text-green text-bold mb-1">Laboratorium</h4>
                                    </div>
                                    <div class="col-md-2 align-self-center">
                                        <a href="" class="arrow-read">
                                            <i class="fa fa-arrow-right"></i>
                    ...
                    <div class="col-md-6 col-xs-6 mt-5">
                        <div class="card" style="border: 0;">
                            ...
                            <div class="card-body card-recent-article">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h4 class="card-text text-green text-bold mb-1">ICU/NICU/PICU</h4>
                                    </div>
                                    <div class="col-md-2 align-self-center">
                                        <a href="" class="arrow-read">
                                            <i class="fa fa-arrow-right"></i>
