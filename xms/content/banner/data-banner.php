        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover" id="myTable">
                    <thead class=".t_head">
                        <tr>
                            <th title="judul">Gambar</th>
                            <th>Posisi</th>
                            <th title="category">Status</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" class="btn bg-gradient-primary"><i class="fas fa-check-circle"></i></i></a>
                                <?php }else{ ?>
                                <a href="" class="btn bg-gradient-danger"><i class="fas fa-times-circle"></i></a>
                                <?php } ?>
                            </td>
